...
public class ProductCategoryResource {
    ...
    @Timed
    public ResponseEntity<List<ProductCategory>> getAllProductCategories(@ApiParam Pageable pageable) {
    ...
    @Timed
    public ResponseEntity<List<ProductCategory>> searchProductCategories(@RequestParam String query, @ApiParam Pageable pageable) {
        log.debug("REST request to search for a page of ProductCategories for query {}", query);
        Page<ProductCategory> page = productCategoryService.search(query, pageable);

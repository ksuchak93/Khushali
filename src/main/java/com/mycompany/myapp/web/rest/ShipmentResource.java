...
public class ShipmentResource {
    ...
    public ResponseEntity<Shipment> createShipment(@RequestBody Shipment shipment) throws URISyntaxException {
        ...
        if (shipment.getId() != null) {
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "idexists", "A new shipment cannot already have an ID")).body(null);
        }
    ...
    @Timed
    public ResponseEntity<List<Shipment>> getAllShipments(@ApiParam Pageable pageable) {
    ...
    @Timed
    public ResponseEntity<List<Shipment>> searchShipments(@RequestParam String query, @ApiParam Pageable pageable) {

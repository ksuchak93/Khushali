...
@Component({
    selector: 'jhi-company-category-my-suffix',
    templateUrl: './company-category-my-suffix.component.html'
})
export class CompanyCategoryMySuffixComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    loadAll() {
        if (this.currentSearch) {
            this.companyCategoryService.search({
                page: this.page - 1,
    ...
    transition() {
        this.router.navigate(['/company-category-my-suffix'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    clear() {
        this.page = 0;
        this.currentSearch = '';
        this.router.navigate(['/company-category-my-suffix', {
            page: this.page,
            sort: this.predicate + ',' + (this.reverse ? 'asc' : 'desc')
        }]);
        this.loadAll();
    ...
    trackId(index: number, item: CompanyCategoryMySuffix) {
        return item.id;
    }

...
@Injectable()
export class ContactMySuffixPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.contactModalRef(component, new ContactMySuffix());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    contactModalRef(component: Component, contact: ContactMySuffix): NgbModalRef {

...
class ContactGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Contact entity")
        ...
        .repeat(2) {
            ...
            .post("/api/contacts")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "firstName":"SAMPLE_TEXT", "lastName":"SAMPLE_TEXT", "title":"SAMPLE_TEXT", "department":"SAMPLE_TEXT", "email":"SAMPLE_TEXT", "officePhone":"SAMPLE_TEXT", "mobile":"SAMPLE_TEXT", "homePhone":"SAMPLE_TEXT", "fax":"SAMPLE_TEXT", "whatsAppId":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
